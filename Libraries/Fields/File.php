...
class File extends Field {
	...
	public function __construct($field, $info, $config)
	{
		...
		if ($isSettings)
		{
			$this->uploadUrl = URL::to_route('admin_settings_file_upload', array($config->name, $this->field));
		}
		else
		{
			$this->uploadUrl = URL::to_route('admin_file_upload', array($config->name, $this->field));
		}
