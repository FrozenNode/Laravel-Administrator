<?php namespace Frozennode\Administrator\Routing;
...
class Filter {
	...
	/**
	 * The eloquent page filter
	 *
	 * @param
	 */
	public function filterEloquentPage($route)
	{
		...
		//run the post-page filter
		return $this->postPageFilter($route);
	}

	/**
	 * The settings page filter
	 *
	 * @param
	 */
	public function filterSettingsPage($route)
	{
	...
	/**
	 * The post-page filter
	 *
	 * @param
	 */
	protected function postPageFilter($route)
	{
