...
<script type="text/javascript">
	var site_url = "<?php echo URL::to('/') ?>",
		...
		save_url = "<?php echo URL::route('admin_settings_save', [$config->getOption('name')]) ?>",
		custom_action_url = "<?php echo URL::route('admin_settings_custom_action', [$config->getOption('name')]) ?>",
		file_url = "<?php echo URL::route('admin_settings_display_file', [$config->getOption('name')]) ?>",
