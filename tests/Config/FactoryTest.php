...
class FactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testValidationRun()
	{
		...
		//set up an initial factory so we can grab the rules
		$factory = new Factory($this->validator, $config);

		$this->validator->shouldReceive('override')->once()->with($config, $factory->getRules())
