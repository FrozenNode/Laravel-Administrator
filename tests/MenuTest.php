...
class MenuTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetMenuSimpleReturnWithPermission()
	{
		...
		$this->configFactory->shouldReceive('make')->once()->andReturn(m::mock(array('getPermission' => true, 'getOption' => 'test_title')));
	...
	{
		$this->config->shouldReceive('get')->once()->andReturn(array('test_name'));
		$this->configFactory->shouldReceive('make')->once()->andReturn(m::mock(array('getPermission' => false)));
